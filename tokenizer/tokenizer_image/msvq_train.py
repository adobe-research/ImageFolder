...
from tokenizer.validation.val_ddp import create_npz_from_sample_folder
...
def parse_args():
    ...
    parser.add_argument("--finetune", typr=str, default=None, help="finetune a pre-trained vq model")
...
def main(args):
    ...
    if args.vq_ckpt:
        ...
        if args.finetune == None:
            ...
            start_epoch = 0           
        del checkpoint
        vq_model = vq_model.finetine(args.enc_tuning_method, args.dec_tuning_method)
