...
class VQLoss(nn.Module):
    ...
    def forward(self, codebook_loss, sem_loss, inputs, reconstructions, optimizer_idx, global_step, last_layer=None,
        ...
        if optimizer_idx == 0:
            ...
            loss = self.rec_weight * rec_loss + \
                ...
                codebook_loss[0] + codebook_loss[1] + codebook_loss[2] + sem_loss
            ...
            if global_step % log_every == 0:
                ...
                logger.info(f"(Generator) rec_loss: {rec_loss:.4f}, perceptual_loss: {p_loss:.4f}, sem_loss: {sem_loss:.4f}, "
                            f"vq_loss: {codebook_loss[0]:.4f}, commit_loss: {codebook_loss[1]:.4f}, entropy_loss: {codebook_loss[2]:.4f}, "
                            f"codebook_usage: {np.mean(codebook_loss[3]):.4f}, generator_adv_loss: {generator_adv_loss:.4f}, "
